...
@section('extra-lib')
    ...
    <script type="text/javascript">
        function getFormInfo(id) {
           ...
           // console.log(id);
            $.ajax({
                url: '{!! route("admin.parameters.getForm") !!}?id='+id,
                type: 'GET',
            })
            .done(function(output) {
                ...
                if(typeof(output.data) == 'undefined'){
                    ...
                    $('#name_parameter').val(output.data.name_parameter);
    ...
    <div class="modal fade" id="getForm" tabindex="-1" role="dialog" aria-labelledby="PostFormLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                {!!Form::open(['url' => URL::route('admin.parameters.postForm'), 'method' => 'POST', 'id' => 'postForm', 'enctype'=>'multipart/form-data'])!!}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        {!!Form::text('name_parameter', null, ['class' => 'form-control', 'id' => 'name_parameter', 'placeholder' => 'Tên danh mục'])!!}
                    </div>
                    <div class="form-group">
